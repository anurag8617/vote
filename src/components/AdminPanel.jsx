...
function AdminPanel({ token, onLogout }) {
  ...
  const handleAddPartySubmit = async (e) => {
    ...
    try {
      await axios.post(API_URL + `/parties/add`, formData, {
        headers: {
  ...
  const handleUpdateParty = async (e) => {
    ...
    try {
      const response = await axios.post(API_URL + `/parties/update`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleDeleteParty = async () => {
    ...
    try {
      await axios.delete(API_URL + `/parties/delete/${currentParty.id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleSettingsSubmit = async (e) => {
    ...
    try {
      await axios.post(API_URL + `/settings/update`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
